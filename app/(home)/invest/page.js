...
import UpdateDialogInvestComponent from "@/app/(home)/invest/UpdateDialogInvestComponent";
...
export default function InvestPage() {
    ...
    const {
        ...
        mutate: mutateData
    } = useSWR(`${process.env.NEXT_PUBLIC_API_URL}/activity/list/invest?page=${page + 1}&limit=${rowsPerPage}&description=${debouncedText}`, fetcher)
    ...
    const addData = () => {
        ...
        axios.request({
            ...
            method: 'POST',
            url: `${process.env.NEXT_PUBLIC_API_URL}/activity/create/invest`,
            data: {
    ...
    const deleteData = () => {
        ...
        axios.request({
            ...
            method: 'DELETE',
            url: `${process.env.NEXT_PUBLIC_API_URL}/activity/delete/invest/${itemId}`,
        }).then(res => {
            setLoading(false)
            if (res.status === 200) {
                handleCloseDelete()
    ...
    return (
        <>
            ...
            <UpdateDialogInvestComponent openUpdateDialog={openUpdateDialog} setOpenUpdateDialog={setOpenUpdateDialog}
