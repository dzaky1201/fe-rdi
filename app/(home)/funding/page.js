...
export default function FundingPage() {
    ...
    const {
        ...
        mutate: mutateData
    } = useSWR(`${process.env.NEXT_PUBLIC_API_URL}/activity/list/funding?page=${page + 1}&limit=${rowsPerPage}&description=${debouncedText}`, fetcher)
    ...
    const addData = () => {
        ...
        axios.request({
            ...
            method: 'POST',
            url: `${process.env.NEXT_PUBLIC_API_URL}/activity/create/funding`,
            data: {
    ...
    const deleteData = () => {
        ...
        axios.request({
            ...
            method: 'DELETE',
            url: `${process.env.NEXT_PUBLIC_API_URL}/activity/delete/funding/${itemId}`,
        }).then(res => {
            setLoading(false)
            if (res.status === 200) {
                handleCloseDelete()
    ...
    return (
        <>
            ...
            <UpdateDialogFundingComponent openUpdateDialog={openUpdateDialog} setOpenUpdateDialog={setOpenUpdateDialog}
